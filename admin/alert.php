...
<div class="sweet-overlay hide" tabindex="-1" style="opacity: 1.07; display: block;">
    <div class="sweet-alert showSweetAlert visible" data-custom-class="" data-has-cancel-button="true"
         ...
         data-animation="pop" data-timer="null" style="display: block; margin-top: -168px;">
        ...
        <p class="title" id="title-text"
           style="display: block; background-color: white;color: crimson;font-weight: 600;font-size: 1.3rem;"></p>
