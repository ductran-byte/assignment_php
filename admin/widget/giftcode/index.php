                    ...
                    <div class="card">
                        <div class="content">
                            <div class="btn-group btn-group-justified">
                                <div style="padding: 10px 10px 10px 0"><a href="/admin/ma-qua-tang/add"><button class="btn-prev"><i class="fa fa-pencil-square-o"></i> ADD GIFT</button></a></div>
                            </div>
                        </div>
                    </div>
                </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <form action="/admin/truy-van-gift" method="post">
                                                                <a href="/admin/?widget=giftcode_edit&id=<?= $gift['id']; ?>" class="btn btn-warning">Sửa</a>
                                                                <button type="submit" name="giftDelete" value="<?= $gift['id']; ?>" class="btn btn-danger">Xoá</button>
                                                            </form>
                                                        </td>
                                                    </tr>
                                                <?php }
