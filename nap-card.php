...
<div class="mb-2">
    <div class="row text-center justify-content-center row-cols-2 row-cols-lg-6 g-2 g-lg-2 mt-1"><div class="col">
        <div class="px-2"><a class="btn btn-menu btn-success w-100 fw-semibold false" href="/">Trang chủ</a>
        </div>
    </div>
    <div class="col">
        <div class="px-2">
            <a class="btn btn-menu btn-success w-100 fw-semibold active" href="nap-tien">Nạp tiền</a>
        </div>
    </div>
    <div class="col">
        <div class="px-2">
    ...
    <div class="col">
        <div class="px-2"><a class="btn btn-menu btn-success w-100 fw-semibold false" href="<?php echo $lienket ?>">Box Zalo</a>
        </div>
    </div>
</div>
</div>
...
<div class="fs-5 fw-semibold text-center">Chọn hình thức nạp</div>
   <div class="row text-center justify-content-center row-cols-2 row-cols-lg-5 g-2 g-lg-2 my-1 mb-2">
      ...
      <div class="col">
         <a class="w-100 fw-semibold" href="nap-card.php">
      ...
      <div class="modal-content">
         <div class="modal-body">
            ...
            <div class="text-center fw-semibold">
               ...
               <a class="w-100 fw-semibold" href="/nap-tien">
               <div class="mt-2 aci"><button type="button"  onclick="handleConfirm()" class="btn-rounded btn btn-primary btn-sm">Chuyển đến momo</button></div>
            </div>
         </div>
      </div>
   </div>
