        ...
        <div class="card-body">
            <div class="mb-3">
                <div class="row text-center justify-content-center row-cols-3 row-cols-lg-6 g-1 g-lg-1">
                    <div class="col"><a class="btn btn-sm btn-success w-100 fw-semibold false" href="/user"
                                        style="background-color: rgb(101, 173, 109);">Tài khoản</a>
                    </div>
                    <div class="col"><a class="btn btn-sm btn-success w-100 fw-semibold active" href="/lich-su"
            ...
            <div class="table-responsive">
                <table class="table align-middle table-row-dashed gy-5 dataTable no-footer" role="table">
                    ...
                    <tr class="text-start fw-bold text-uppercase gs-0">
                        <th colspan="1" role="columnheader" class="table-sort-desc text-primary"
                    ...
                    <tr>
                        <td colspan="5">
                            <div class="d-flex text-center w-100 align-content-center justify-content-center">Không có
                                bản ghi nào
                            </div>
                        </td>
                    </tr>
