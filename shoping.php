...
<div class="box" style="background-color: #198754;">  
    <div class="box-content">
        ...
        <ul class="nav nav-justified" id="tabRanking" role="tablist">
            <li class="nav-item" role="presentation"><button type="button" id="fill-tab-example-tab-1" role="tab" data-rr-ui-event-key="1" aria-controls="fill-tab-example-tabpane-1" aria-selected="false" class="nav-link1 btlr-5 demo active" data-bs-toggle="tab" data-bs-target="#fill-tab-example-tabpane-1">Vũ Khí</button></li>
            <li class="nav-item" role="presentation"><button type="button" id="fill-tab-example-tab-2" role="tab" data-rr-ui-event-key="2" aria-controls="fill-tab-example-tabpane-2" aria-selected="false" class="nav-link1 demo" data-bs-toggle="tab" data-bs-target="#fill-tab-example-tabpane-2">Thời Trang</button></li>
            <li class="nav-item" role="presentation"><button type="button" id="fill-tab-example-tab-3" role="tab" data-rr-ui-event-key="3" aria-controls="fill-tab-example-tabpane-3" aria-selected="false" class="nav-link1 demo btrr-5" data-bs-toggle="tab" data-bs-target="#fill-tab-example-tabpane-3">Linh Tinh</button></li>
        </ul>
    </div>
</div>
...
<div>
    <div class="tab-content" id="tabRankingContent">
        <div role="tabpanel" id="fill-tab-example-tabpane-1" aria-labelledby="fill-tab-example-tab-1" class="fade tab-pane">
        <?php
            ...
            <div class="item" style="background: #FDF8DA;">
                ...
                <div class="item-title">
                    ...
                    <p style="color: #95954d; font-size: 14px; font-weight: 400;">Giá : <?= number_format($row['gia_coin']); ?> Coin</p>
                </div>
                <div class="item-btn">
                    <button style="background-color: #a0c49d;" id="btn-view" data-bs-toggle="collapse" data-bs-target="#collapseExample<?= $row['id']; ?>" aria-expanded="false" aria-controls="collapseExample" >Xem</button>
                </div>
            </div>
            <div class="collapse" id="collapseExample<?= $row['id']; ?>" >
                <div class="box-collap" style="background: #FDF8DA;">
                    ...
                    <p><span style="color: #d500f9; font-size: 13px; font-weight: 700;">Giá Bán: <?= number_format($row['gia_coin']); ?> Coin</span> </p>
                    <p><span style="color: #ff3d00; font-size: 13px; font-weight: 600;"><?= $row['chi_so_web']; ?></span></p>
                    <div class="item-btn-coll">
                        <button type="submit" name="" value=""  class="btn btn-success btnBuy<?= $row['id']; ?>">MUA</button>
            ...
            <div class="box-alert item<?= $row['id']; ?> hide">
                <div class="alert-content" style="background: #e1ecc8; border: 2px solid #198754; border-radius: 15px;">
                    <div class="alert-header">
                        <h2 class="alert-title" style="display: flex;">Xác Nhận Mua Vật Phẩm</h2>
                    </div>
                    <div class="alert-text">
                        <div style="display: block;">Hãy Chắc Chắn Bạn Đã ĐĂNG XUẤT Và THOÁT KHỎI GAME Trước Khi Thực Hiện Giao Dịch . Nếu Chưa Thoát Khỏi Game Và Cố Tình Mua Item , Bị Lỗi Chúng Tôi Không Chịu Trách Nhiệm Và Không Hoàn Trả Bất Cứ Vật Phẩm Hay Coin . Mong Các Ninja Lưu Ý..</div>
                    </div>
                    <div class="alert-action" style="display: flex;">
                        <form action="" method="POST" >
                            ...
                            <button type="submit" name="buyWebshop" value="<?= $row['id']; ?>" class="swal2-confirm swal2-styled" style="background-color: #198754cc; border-left-color: rgb(48, 133, 214); border-right-color: rgb(48, 133, 214);">Xác Nhận</button>
                            <button type="button" class="swal2-cancel swal2-styled cancel<?= $row['id']; ?>" style="display: inline-block; background-color: rgb(221 51 51 / 89%);">Không</button>
                        </form>
        ...
        <div role="tabpanel" id="fill-tab-example-tabpane-2" aria-labelledby="fill-tab-example-tab-2" class="fade tab-pane active show">
        <?php
            ...
            <div class="collapse" id="collapseExample<?= $row['id']; ?>" >
                <div class="box-collap" style="background: #FDF8DA;">
                    ...
                    <p><span style="color: #ab0202; font-size: 13px; font-weight: 400;">Giá Bán: <?= number_format($row['gia_coin']); ?> Coin</span> </p>
                    <p><span style="color: #06800e; font-size: 13px; font-weight: 400;"><?= $row['chi_so_web']; ?></span></p>
                    <div class="item-btn-coll">
                        <button type="submit" name="" value=""  class="btn btn-success btnBuy<?= $row['id']; ?>">MUA</button>
                        <!-- <form action="" method="POST" >
                            <button type="submit" name="buyWebshop" value="<?= $row['id']; ?>"  class="btn btn-success">MUA</button>
        ...
        <div role="tabpanel" id="fill-tab-example-tabpane-3" aria-labelledby="fill-tab-example-tab-3" class="fade tab-pane active show">
        <?php
...
<div class="box-content-end" style="font-weight: 400;font-family: math;text-shadow: 0 0 #c0ae77;height: 22px;color: cornsilk;text-align: center;">Tác Giả Mịa Gì Hê Hê</div><br>
